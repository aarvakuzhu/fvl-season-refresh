...
const PLAYER_REGISTRY = [
  ...
  {name:"Pavan",photo:'https://lh3.googleusercontent.com/d/19SlcPbRo_DkrUIFoIgnJqGHyNzbl6Mr8=w400',skills:["Setter", "Spiker"],seasons:[{season:2,team:"Dragons",role:"Player",championMonths:["March 2026", "April 2026"],seasonChampion:false},{season:3,team:"Predators",role:"Player",championMonths:[],seasonChampion:false}]},
...
const S3_TEAMS = [
  ...
  { name:'Predators', captain:'Harsha',   color:'#1b5e20', slug:'predators',
    players:['Gopal','Mukhesh','Pavan','Rakesh','Sachin','Uday B'] },
...
const S3_MONTHS = [
  ...
  { month:4, label:'August 2026',   date:'Sun 16 Aug 2026' },
  { month:5, label:'September 2026',date:'Sun 13 Sep 2026' },
  { month:6, label:'October 2026',  date:'TBD'             },
];
